...
<head>
    ...
    <script>
        Weglot.on("switchersReady", function(initialLanguage) {
            ...
            $( '.dropdown-menu-lang' ).html('<li><a href="'+Weglot.options.host+'/en" class="is_login"><span class="flag-icon flag-icon-gb"></span> English</a></li><li><a href="'+Weglot.options.host+'/ar"  class="is_login"><span class="flag-icon flag-icon-sa"></span> العربية</a></li><li><a href="'+Weglot.options.languages[0].connect_host_destination.host+'" class="is_login"><span class="flag-icon flag-icon-fr"></span> Français</a></li><li><a href="'+Weglot.options.languages[1].connect_host_destination.host+'" class="is_login"><span class="flag-icon flag-icon-ru"></span>  Pусский</a></li><li><a href="'+Weglot.options.languages[2].connect_host_destination.host+'" class="is_login"><span class="flag-icon flag-icon-tr"></span>  Türk</a></li>');
            console.log("after");
            console.log($( '.dropdown-menu-lang' ).html());
        })
        Weglot.initialize({
