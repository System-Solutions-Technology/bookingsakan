...
<head>
    ...
    <script>
        Weglot.on("switchersReady", function(initialLanguage) {
            ...
            $( '.dropdown-menu-lang' ).html('<li><a href="www.bookingsaken.com/en" class="is_login"><span class="flag-icon flag-icon-gb"></span> English</a></li><li><a href="www.bookingsaken.com/ar"  class="is_login"><span class="flag-icon flag-icon-sa"></span> العربية</a></li><li><a href="fr.bookingsaken.com" class="is_login"><span class="flag-icon flag-icon-fr"></span> Français</a></li><li><a href="ru.bookingsaken.com" class="is_login"><span class="flag-icon flag-icon-ru"></span>  Pусский</a></li><li><a href="tr.bookingsaken.com" class="is_login"><span class="flag-icon flag-icon-tr"></span>  Türk</a></li>');
            console.log("after");
            console.log($( '.dropdown-menu-lang' ).html());
        })
        Weglot.initialize({
