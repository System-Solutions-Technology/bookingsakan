                ...
                <div class="g-form-control">
                    <ul class="nav nav-tabs" role="tablist">
                        @if(!empty($service_types))
                            ...
                            @endforeach
                            <li role="bravo_timeshare">
                                    <a href="#bravo_timeshare" class="" aria-controls="bravo_timeshare" role="tab" data-toggle="tab">
                        ...
                        @if(!empty($service_types))
                            @foreach ($service_types as $k => $service_type)
                                ...
                                ?>
                                    ...
                                    @endforeach
                                    <div role="tabpanel" class="tab-pane" id="bravo_timeshare">
                                                    ...
                                                    <div class="g-field-search">
                                                        <div class="row">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-content">
                                                                        ...
                                                                        <div class="smart-search">
                                                                            <input type="text" class="smart-search-location parent_text form-control" {{ ( empty(setting_item("hotel_location_search_style")) or setting_item("hotel_location_search_style") == "normal" ) ? "readonly" : ""  }} placeholder="{{__("Choose a place !")}}" value="{{ $location_name }}" data-onLoad="{{__("Loading...")}}"
                                                            ...
                                                            <div class="col-md-4 border-right">
                                                                <div class="form-group">
                                                                    <i class="field-icon icofont-ui-calendar"></i>
                                                                    <div class="form-content">
